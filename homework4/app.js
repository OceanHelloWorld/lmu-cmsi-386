...
var _user$project$Main$model = {firstDate: 'mm/dd/yyyy', secondDate: 'mm/dd/yyyy'};
var _user$project$Main$outputDate = F2(
	function (startDate, endDate) {
		var _p1 = {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Date$fromString(startDate),
			_1: _elm_lang$core$Date$fromString(endDate)
		};
		if (_p1._0.ctor === 'Ok') {
			if (_p1._1.ctor === 'Ok') {
				return A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(
							A3(_justinmimbs$elm_date_extra$Date_Extra$diff, _justinmimbs$elm_date_extra$Date_Extra$Day, _p1._0._0, _p1._1._0)),
						' days.'));
			} else {
				return _p1._1._0;
			}
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {firstDate: a, secondDate: b};
	});
var _user$project$Main$ChangeDate2 = function (a) {
	return {ctor: 'ChangeDate2', _0: a};
};
var _user$project$Main$ChangeDate1 = function (a) {
	return {ctor: 'ChangeDate1', _0: a};
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Date Calculator'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$ChangeDate1),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.firstDate),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
						...
						{ctor: '[]'},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$ChangeDate2),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.secondDate),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(_user$project$Main$outputDate, model.firstDate, model.secondDate)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
